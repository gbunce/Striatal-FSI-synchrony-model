...
cc = px; % Correlation Coefficient for lateral connections
            ...
            while t < time
                if t == 0
                    ...
                    if t == 1
                        ...
                        for i = 1:n
                            p_lat = cc(m).*((fsi_sp(t-1,:)-p0)) * lat_c(:, i); % The minus px, ensures that only deflections in the probability are shared. Otherwise the FSIs cause each other to fire.
